...
class SendVisitorAppPromotionNotificationJob implements ShouldQueue
{
    ...
    public function sendNotification()
    {
        ...
        $payload = [
            "payload" => [
                "name" => "1to1_connect_app_notification",
                "components" => [
                    [
                        "type" => "header",
                        "parameters" => [
                            [
                                "type" => "image",
                                "image" => [
                                    "link" => "https://crm.medicall.in/images/1-to-1-connect-logo.jpg",
                                ],
                            ],
                        ],
                    ],
