...
class MenuCardBeverage extends Component
{
    public function render()
    {
        ...
        $specialMenuTimings = Category::where('type', 'beverage')
            ->where('is_active', 1)
        ...
        $beverageItems = MenuItem::with('category')
        ...
        return view('livewire.menu-card-beverage',[
